                                    ...
                                    <div className="flex items-start justify-between gap-3">
                                        <div className="flex items-center gap-3 min-w-0 flex-1">
                                            ...
                                            <div className="min-w-0 flex-1">
                                                <p className="font-medium text-sm text-gray-900 dark:text-white truncate">{r.user_name}</p>
                                                <p className="text-xs text-gray-600 dark:text-gray-400 truncate">{r.user_email}</p>
                                            </div>
                                        </div>
                                        ...
                                        {!r.is_approved && (
                                            <button
                                                ...
                                                className="p-2 rounded-xl bg-emerald-100 dark:bg-emerald-600/20 text-emerald-700 dark:text-emerald-400 hover:bg-emerald-200 dark:hover:bg-emerald-600/30 border border-emerald-300 dark:border-emerald-500/30 transition-colors"
                                        ...
                                        {r.is_approved && (
                                            <button
                                                ...
                                                className="p-2 rounded-xl bg-amber-100 dark:bg-amber-600/20 text-amber-700 dark:text-amber-400 hover:bg-amber-200 dark:hover:bg-amber-600/30 border border-amber-300 dark:border-amber-500/30 transition-colors"
                                        ...
                                        <button
                                            ...
                                            className="p-2 rounded-xl bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-400 hover:bg-blue-200 dark:hover:bg-blue-600/30 border border-blue-300 dark:border-blue-500/30 transition-colors"
                                            title={t("reviewReply")}
                                        >
