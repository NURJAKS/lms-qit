                      ...
                      <div className="p-4 flex flex-col gap-2">
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="flex items-start gap-3 min-w-0 flex-1">
                            <div className="w-8 h-8 rounded-lg flex shrink-0 items-center justify-center bg-green-100 dark:bg-green-900/40 text-green-600 dark:text-green-400 mt-0.5">
                              <ClipboardList className="w-4 h-4" />
                            </div>
                            <span className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base break-words line-clamp-2">
                              {a.title}
                            </span>
                          </div>
                          
                          {isExpanded ? (
                            <span className="text-xs font-bold text-gray-400 shrink-0 self-start mt-1.5">{t("hide")}</span>
                          ) : (
                            <span className="text-xs sm:text-sm font-bold text-blue-600 px-2.5 py-1 rounded-lg bg-blue-50/50 hover:bg-blue-50 dark:bg-blue-900/10 dark:hover:bg-blue-900/30 transition-colors shrink-0 self-start">
                              {t("viewDetails")}
                            </span>
                          )}
                        </div>
                        ...
                        <div className="pl-11">
                          <span className="inline-flex items-center px-2 py-0.5 rounded text-[10px] sm:text-xs font-bold bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400">
                            {a.grade != null 
