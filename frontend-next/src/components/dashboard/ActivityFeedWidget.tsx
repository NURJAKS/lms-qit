      ...
      try {
        if (teacherMode) {
          ...
          return data.map(s => ({
            ...
            group: s.group_name,
            time: s.submitted_at,
            link: `/app/teacher/courses/${s.group_id}/assignment/${s.assignment_id}?tab=student-work&studentId=${s.student_id}`,
          }));
        } else {
      ...
      <div className="p-4">
        <AnimatePresence mode="popLayout">
          {activities.length === 0 && !isLoading ? (
            ...
            <div className="space-y-3 max-h-[380px] overflow-y-auto pr-1.5 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-700 scrollbar-track-transparent">
