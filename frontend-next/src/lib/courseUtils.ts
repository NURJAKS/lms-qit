...
export const TOPIC_TITLE_KEYS: Record<string, string> = {
  ...
  "Python Программалау:": "topicPythonProgrammingTitle",
  "Python программалау:": "topicPythonProgrammingTitle",
  "Программирование на Python:": "topicPythonProgrammingTitle",
  "Python Programming:": "topicPythonProgrammingTitle",
};
...
export function getLocalizedTopicTitle<K extends string>(title: string, t: (key: K) => string): string {
  ...
  const key = TOPIC_TITLE_KEYS[cleanTitle];
  return key ? (t as (key: string) => string)(key) : cleanTitle;
}
