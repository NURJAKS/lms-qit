        ...
        <div className="min-w-0">
          ...
          {(progress_detail?.courses?.length ?? 0) > 0 && (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-6">
              <div className="lg:col-span-1 min-w-0 bg-gray-50 dark:bg-gray-700/50 rounded-[20px] border border-gray-200 dark:border-gray-600 p-4 sm:p-6 shadow-sm">
                <h2 className="font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
                  <BookOpen className="w-5 h-5" /> {t("profileProgressGeneral")}
                </h2>
                <div className="flex flex-row sm:flex-col items-center justify-center gap-6 sm:gap-4 py-2">
                  <div className="relative w-24 h-24 sm:w-32 sm:h-32 shrink-0">
                    ...
                    <span className="absolute inset-0 flex items-center justify-center text-xl sm:text-2xl font-bold text-gray-800 dark:text-white">{overallProgress}%</span>
                  </div>
                  <div className="text-left sm:text-center min-w-0 flex-1 flex-shrink">
                    <p className="text-lg font-black text-gray-800 dark:text-white">{overallProgress}%</p>
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-[150px] sm:max-w-none leading-relaxed whitespace-normal break-words">{t("profileCourseProgress")}</p>
                  </div>
                </div>
              </div>
              <div className="lg:col-span-2 min-w-0 bg-gray-50 dark:bg-gray-700/50 rounded-[20px] border border-gray-200 dark:border-gray-600 p-4 sm:p-6 shadow-sm">
                <h2 className="font-semibold text-gray-800 dark:text-white mb-4 flex items-center gap-2">
