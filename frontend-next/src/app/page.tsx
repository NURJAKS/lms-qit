      ...
      <footer id="contact" className="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div>
              <h3 className="text-lg font-bold text-gray-900 dark:text-white font-montserrat mb-1">{t("platformName")}</h3>
            ...
            <div>
              ...
              <div className="flex gap-2">
                <a href="https://www.instagram.com/qazaqitacademy?igsh=MWxzbmNxZzJwMXE0Zw%3D%3D&utm_source=qr" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-pink-500/20 flex items-center justify-center text-pink-600 dark:text-pink-400 hover:bg-pink-500/30 transition-colors" aria-label={t("instagram")}>
                  <Instagram className="w-4 h-4" />
                </a>
                <a href="https://t.me/qazaqitacademy" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-sky-500/20 flex items-center justify-center text-sky-600 dark:text-sky-400 hover:bg-sky-500/30 transition-colors" aria-label={t("telegram")}>
                ...
                <a href="https://chat.whatsapp.com/H7zVHSuISNVGFobjwclNe3" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-green-500/20 flex items-center justify-center text-green-600 dark:text-green-400 hover:bg-green-500/30 transition-colors" aria-label={t("whatsapp")}>
