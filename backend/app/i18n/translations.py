...
EMAIL_TRANSLATIONS = {
    "ru": {
        ...
        "login": "Логин:",
        "password": "Пароль:",
        "password_change_hint": "При желании вы можете изменить пароль, связавшись с менеджером нашей академии.",
    ...
    "kk": {
        ...
        "login": "Логин:",
        "password": "Құпия сөз:",
        "password_change_hint": "Қаласаңыз, құпия сөзді академия менеджеріне хабарласу арқылы өзгерте аласыз.",
    ...
    "en": {
        ...
        "login": "Login:",
        "password": "Password:",
        "password_change_hint": "If you wish, you can change your password by contacting our academy manager.",
