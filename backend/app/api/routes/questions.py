...
def list_my_questions(
    ...
    for q in questions:
        ...
        out.append({
            ...
            "options": _question_options_list(q.options),
            "correct_option": q.correct_option if ans and ans.grade is not None and _api_question_type_row(q.question_type, q.options) == "single_choice" else None,
